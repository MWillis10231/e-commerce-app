...
export default function About() {
    return(
        <div className="Content">
            ...
            <p>If you find any issues or you'd like to give feedback, please submit them on <a href="https://github.com/MWillis10231/e-commerce-app" target="_blank" rel="noreferrer">GitHub</a></p>
